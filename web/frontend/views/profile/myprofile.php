...
/* @var $modelsc app\models\FormStateCountry */
/* @var $modelcp app\models\FormChangePassword */
    ...
    <div class="col-md-3">
        <div class="box box-primary">
            <div class="box-body box-profile">
                ...
                <a href="#" class="btn btn-primary btn-flat btn-block"><b>Cambiar foto</b></a>
            </div>
            <!-- /.box-body -->
        </div>
    </div>
